...
_HEDGE = re.compile(
    ...
    r"|ach(?:o|a|as|e|em|amos|am|ei|ou|aram|ava|avam|avamos|aria|ariam|ariamos|ando)\s+que"
    r"|cre(?:io|s|mos|em|ia|iam|iamos|ndo)\s+que|cr[eê]\s+que"
    r"|imagin(?:o|a|as|e|em|amos|am|ei|ou|aram|ava|avam|avamos|aria|ariam|ando)\s+que"
    r"|pens(?:o|a|as|e|em|amos|am|ei|ou|aram|ava|avam|avamos|aria|ariam|ando)\s+que"
